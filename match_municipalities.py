...
AGGREGATED_PATH = os.path.join(DATA_DIR, "aggregated_by_beneficiary.json")
IRREGULARITIES_PATH = os.path.join(DATA_DIR, "irregularities_by_ico.json")
...
OUTPUT_STATS_PATH = os.path.join(DATA_DIR, "municipal_stats.json")
